  ...
  <div class="router-history">
    ...
    >
      <el-tab-pane
        ...
        class="gva-tab"
      >
        <span slot="label" :style="{color: activeValue===name(item)?$GIN_VUE_ADMIN.activeColor:'#333'}"><i class="dot" :style="{backgroundColor:activeValue===name(item)?$GIN_VUE_ADMIN.activeColor:'#ddd'}" /> {{ item.meta.title }}</span>
      </el-tab-pane>
    </el-tabs>
